      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300">Follow us on social media for updates and educational content</p>
          </div>
          ...
          <div className="flex justify-center space-x-6">
            {[
              ...
              <a
                key={index}
                href="#"
                className={`w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center ${social.color} transition-colors`}
                title={social.name}
              >
